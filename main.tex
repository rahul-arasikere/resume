...
\begin{minipage}[t]{0.365\textwidth} % 45% of the page width for name
	...
	\colorbox{RoyalBlue}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Rahul}}}}} % First name
	
	\colorbox{RoyalBlue}{{\HUGE\textcolor{white}{\textbf{\MakeUppercase{Arasikere}}}}} % Last name
